...
struct TriviaAPI {
    ...
    static let fallbackQuestions: [TriviaQuestion] = [
        ...
        TriviaQuestion(
            category: "Computing",
            difficulty: "medium",
            prompt: "Which data format does MiNi ARCADE use to persist completed sessions in UserDefaults?",
            correctAnswer: "JSON",
        ...
        TriviaQuestion(
            category: "Stats",
            difficulty: "medium",
            prompt: "Which Charts mark is used by MiNi ARCADE for vertical score bars?",
